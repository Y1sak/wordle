...
export const WORD_NOT_FOUND_MESSAGE = 'No hay suficientes letras'
...
export const DISCOURAGE_INAPP_BROWSER_TEXT =
  "Está utilizando un navegador incorporado y puede tener problemas para compartir o guardar sus resultados. Le recomendamos que utilice el navegador predeterminado de su dispositivo."
